...
fn read_shunt_voltage_nanovolts_adcmode_1_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x00, 0x00, 0x10]),
        SPITransaction::transaction_end(),
        SPITransaction::transaction_start(),
        SPITransaction::transfer_in_place(
            vec![0x11, 0x00, 0x00, 0x00],
...
fn read_shunt_overvoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::transfer_in_place(vec![0x31, 0x00, 0x00], vec![0x00, 0x7E, 0x90]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn write_shunt_overvoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x30, 0x7E, 0x90]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn read_shunt_undervoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::transfer_in_place(vec![0x35, 0x00, 0x00], vec![0x00, 0x81, 0x70]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn read_bus_overvoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::transfer_in_place(vec![0x39, 0x00, 0x00], vec![0x00, 0x41, 0x00]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn write_bus_overvoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x38, 0x41, 0x00]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn read_bus_undervoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::transfer_in_place(vec![0x3D, 0x00, 0x00], vec![0x00, 0x0C, 0x80]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn write_bus_undervoltage_threshold_raw_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x3C, 0x0C, 0x80]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn set_bus_overvoltage_threshold_raw_accepts_max_valid_value_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x38, 0x7F, 0xFF]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
...
fn set_bus_undervoltage_threshold_raw_accepts_max_valid_value_works() {
    ...
    let spi_expectations = [
        SPITransaction::transaction_start(),
        SPITransaction::write_vec(vec![0x3C, 0x7F, 0xFF]),
        SPITransaction::transaction_end(),
    ];
    let spi = SPIMock::new(&spi_expectations);
    let mut ina229 = INA229::new(spi);
